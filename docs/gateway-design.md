...
2. Verify with `prevail-rust` using `SondePlatform` — a custom Prevail platform that defines helper prototypes for sonde helpers 1–16 (GW-0401, GW-0404). Prevail's loader resolves ELF map relocations to `LDDW src=1, imm=<map_index>`.
