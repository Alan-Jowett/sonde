...
**Specification**:
<!-- PASTE SPECIFICATION TEXT WITH COST CONSTRAINTS — requirements doc sections -->

**Budget / Analysis Artifact**:
<!-- PASTE COST BUDGET / BOM COST ROLLUP HERE — table or spreadsheet export -->

**Budget Type**: cost

**Context**: BOM cost target per HW-0601: ≤$5 USD excluding PCB fabrication.

**Audience**: <!-- SPECIFY AUDIENCE — e.g., "program managers assessing cost risk", "procurement engineers" -->
