...
2. The firmware enters the active GPIO state, waits 1 ms for the sensor rail and attached buses to settle, then takes the battery measurement before calling the BPF interpreter when a program is available.
