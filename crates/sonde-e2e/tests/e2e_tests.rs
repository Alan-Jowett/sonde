...
async fn t_e2e_030_app_data_round_trip() {
    ...
    let bytecode = [
        ...
        0x07, 0x03, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, // -256
        // mov r4, 64 — reply capacity
        0xb7, 0x04, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00,
        // mov r5, 5000 — timeout ms
        0xb7, 0x05, 0x00, 0x00, 0x88, 0x13, 0x00, 0x00,
        // call 9 — helper_send_recv
        0x85, 0x00, 0x00, 0x00, 0x09, 0x00, 0x00, 0x00,
        // exit (r0 = reply_len or error)
        0x95, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ];
